...
2. Copy and convert the demo certificate for docker.mender.io
    ```
    wget --output-document mender.pem https://raw.githubusercontent.com/mendersoftware/mender-server/main/compose/certs/mender.crt
    openssl x509 -in mender.pem -outform der -out mender.der
    ```
